...
(function (FDBZAP) {
    ...
    (function (Controls) {
        ...
        var RichTextBoxControl = (function () {
            ...
            RichTextBoxControl.prototype._destroy = function (destroy) {
            ...
            RichTextBoxControl.prototype._disableControlInteraction = function () {
            ...
            RichTextBoxControl.prototype._enableControlInteraction = function () {
            ...
            RichTextBoxControl.prototype._getMaxLength = function () {
                console.log("RichTextBoxControl._getMaxLength");
                return this.context.parameters.value.attributes.MaxLength;
            };
            RichTextBoxControl.prototype._getAttributeName = function () {
            ...
            RichTextBoxControl.prototype._onChange = function (evt, propertyName, newValue, oldValue) {
                ...
                if (this.editor) {
                    ...
                    if (data.length > this._getMaxLength()) {
                        return false;
                    }
